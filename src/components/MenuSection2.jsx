...
import ChickenWingsBBQ from "../assets/Menu/BuffaloWings.png";
import CreamyPumpkinSoup from "../assets/Menu/HerbRoastedChicken.png";
import CrispyCaesarSalad from "../assets/Menu/ChickenWingsBBQ.png";
import CapreseSkewers from "../assets/Menu/CreamyPumpkinSoup.png";
import BuffaloWings from "../assets/Menu/CrispyCaesarSalad.png";
...
const menuItems = [
  ...
  },
  {
    ...
    type: "Main Course",
    price: "$11",
    desc: "Grilled chicken wings coated in a smoky barbecue glaze with sesame seeds. Juicy, tender, and packed with bold flavor in every bite.",
    img: ChickenWingsBBQ,
  },
  {
  ...
  },
  {
    ...
    type: "Main Course",
    price: "$10",
    desc: "Crispy chicken wings tossed in our spicy buffalo sauce, served with celery sticks and blue cheese dressing.",
    img: BuffaloWings,
  },
  {
